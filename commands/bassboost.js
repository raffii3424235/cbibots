...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        if (!args[0]) return client.sendTime(message.channel, "**Harap berikan tingkatan bassboost. \nTingkatan yang tersedia:** `none`, `low`, `medium`, `high`"); //if the user do not provide args [arguments]
        ...
        return client.sendTime(message.channel, `✅ | **Bassboost diatur ke** \`${level}\``);
    },
    SlashCommand: {
        options: [
            {
                name: "level",
                description: `Harap berikan tingkatan bassboost. Tingkatan yang tersedia: low, medium, high, or none`,
                value: "[level]",
                type: 3,
                required: true,
            },
        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (!args) return client.sendTime(interaction, "**Harap berikan tingkatan bassboost. \nTingkatan yang tersedia:** `none`, `low`, `medium`, `high`"); //if the user do not provide args [arguments]
            ...
            return client.sendTime(interaction, `✅ | **Bassboost diatur ke** \`${level}\``);
        },
    },
};
